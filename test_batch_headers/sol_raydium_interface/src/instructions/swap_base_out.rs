...
///Accounts struct for the swapBaseOut instruction
...
///Public keys struct for the swapBaseOut instruction
...
impl From<&[String]> for SwapBaseOutKeys {
...
///Arguments for the swapBaseOut instruction
...
impl Default for SwapBaseOutIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 11u8,
...
impl From<SwapBaseOutIxArgs> for RaydiumProgramIx {
    fn from(args: SwapBaseOutIxArgs) -> Self {
