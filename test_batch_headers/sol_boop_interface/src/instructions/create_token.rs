...
///Accounts struct for the create_token instruction
...
///Public keys struct for the create_token instruction
...
impl From<&[String]> for CreateTokenKeys {
...
pub const CREATE_TOKEN_IX_DISCM: [u8; 8] = [84, 52, 204, 228, 24, 140, 234, 75];
///Arguments for the create_token instruction
...
impl Default for CreateTokenIxArgs {
    fn default() -> Self {
        Self {
            discriminator: [84u8, 52u8, 204u8, 228u8, 24u8, 140u8, 234u8, 75u8],
        ...
        if maybe_discm != CREATE_TOKEN_IX_DISCM {
            return Err(std::io::Error::new(
                ...
                format!(
                    ...
                    CREATE_TOKEN_IX_DISCM, maybe_discm
                ),
            ));
        }
        Ok(Self(CreateTokenIxArgs::deserialize(&mut reader)?))
    }
...
pub fn create_token_ix(
    ...
    create_token_ix_with_program_id(crate::ID, keys, args)
}
...
pub fn create_token_invoke(
    ...
    create_token_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn create_token_invoke_signed(
    ...
    create_token_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
...
impl From<CreateTokenIxArgs> for BoopProgramIx {
    fn from(args: CreateTokenIxArgs) -> Self {
