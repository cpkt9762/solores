...
///Accounts struct for the deploy_bonding_curve_fallback instruction
...
///Public keys struct for the deploy_bonding_curve_fallback instruction
...
impl From<DeployBondingCurveFallbackAccounts<'_, '_>> for DeployBondingCurveFallbackKeys {
...
impl From<&[String]> for DeployBondingCurveFallbackKeys {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; DEPLOY_BONDING_CURVE_FALLBACK_IX_ACCOUNTS_LEN]>
    for DeployBondingCurveFallbackAccounts<'me, 'info>
{
    fn from(arr: &'me [AccountInfo<'info>; DEPLOY_BONDING_CURVE_FALLBACK_IX_ACCOUNTS_LEN]) -> Self {
        Self {
            mint: &arr[0],
...
pub const DEPLOY_BONDING_CURVE_FALLBACK_IX_DISCM: [u8; 8] = [53, 230, 172, 84, 77, 174, 22, 61];
///Arguments for the deploy_bonding_curve_fallback instruction
...
impl Default for DeployBondingCurveFallbackIxArgs {
    fn default() -> Self {
        Self {
            discriminator: [53u8, 230u8, 172u8, 84u8, 77u8, 174u8, 22u8, 61u8],
        ...
        if maybe_discm != DEPLOY_BONDING_CURVE_FALLBACK_IX_DISCM {
            return Err(std::io::Error::new(
                ...
                format!(
                    ...
                    DEPLOY_BONDING_CURVE_FALLBACK_IX_DISCM, maybe_discm
                ),
            ));
        }
        Ok(Self(DeployBondingCurveFallbackIxArgs::deserialize(
            &mut reader,
        )?))
    }
...
pub fn deploy_bonding_curve_fallback_ix_with_program_id(
    ...
    let metas: [AccountMeta; DEPLOY_BONDING_CURVE_FALLBACK_IX_ACCOUNTS_LEN] = keys.into();
...
pub fn deploy_bonding_curve_fallback_invoke(
    ...
    deploy_bonding_curve_fallback_invoke_with_program_id(crate::ID, accounts, args)
}
...
pub fn deploy_bonding_curve_fallback_invoke_signed(
    ...
    deploy_bonding_curve_fallback_invoke_signed_with_program_id(crate::ID, accounts, args, seeds)
}
...
impl DeployBondingCurveFallbackIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<DeployBondingCurveFallbackIxArgs> for BoopProgramIx {
    fn from(args: DeployBondingCurveFallbackIxArgs) -> Self {
