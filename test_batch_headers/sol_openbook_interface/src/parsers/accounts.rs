...
pub fn try_unpack_account(data: &[u8]) -> Result<OpenbookAccount, std::io::Error> {
    ...
    match data_len {
        MARKET_STATE_V2_LEN => Ok(OpenbookAccount::MarketStateV2(MarketStateV2::from_bytes(
            data,
        )?)),
        MARKET_STATE_LEN => Ok(OpenbookAccount::MarketState(MarketState::from_bytes(data)?)),
        OPEN_ORDERS_LEN => Ok(OpenbookAccount::OpenOrders(OpenOrders::from_bytes(data)?)),
        REQUEST_QUEUE_HEADER_LEN => Ok(OpenbookAccount::RequestQueueHeader(
            RequestQueueHeader::from_bytes(data)?,
        )),
        REQUEST_LEN => Ok(OpenbookAccount::Request(Request::from_bytes(data)?)),
        EVENT_QUEUE_HEADER_LEN => Ok(OpenbookAccount::EventQueueHeader(
            EventQueueHeader::from_bytes(data)?,
        )),
        EVENT_LEN => Ok(OpenbookAccount::Event(Event::from_bytes(data)?)),
...
mod tests {
    ...
    fn test_market_state_v_2_consistency() {
        ...
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::MarketStateV2(account)) => {
                assert_eq!(
    ...
    fn test_market_state_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::MarketState(account)) => {
                assert_eq!(
    ...
    fn test_open_orders_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::OpenOrders(account)) => {
                assert_eq!(
                    account.account_flags, expected_first_field,
                    "First field value should match expected value"
                );
    ...
    fn test_request_queue_header_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::RequestQueueHeader(account)) => {
                assert_eq!(
                    account.account_flags, expected_first_field,
                    "First field value should match expected value"
                );
    ...
    fn test_request_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::Request(account)) => {
                assert_eq!(
    ...
    fn test_event_queue_header_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::EventQueueHeader(account)) => {
                assert_eq!(
                    account.account_flags, expected_first_field,
                    "First field value should match expected value"
                );
    ...
    fn test_event_consistency() {
        ...
        let test_data = test_account.try_to_vec().unwrap();
        match try_unpack_account(&test_data) {
            Ok(OpenbookAccount::Event(account)) => {
                assert_eq!(
