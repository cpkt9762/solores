...
///Accounts struct for the migration_damm_v2_create_metadata instruction
...
///Public keys struct for the migration_damm_v2_create_metadata instruction
...
impl From<MigrationDammV2CreateMetadataKeys>
    for [AccountMeta; MIGRATION_DAMM_V2_CREATE_METADATA_IX_ACCOUNTS_LEN]
{
...
impl From<[Pubkey; MIGRATION_DAMM_V2_CREATE_METADATA_IX_ACCOUNTS_LEN]>
    for MigrationDammV2CreateMetadataKeys
{
...
impl From<&[String]> for MigrationDammV2CreateMetadataKeys {
...
impl<'me, 'info> From<&'me [AccountInfo<'info>; MIGRATION_DAMM_V2_CREATE_METADATA_IX_ACCOUNTS_LEN]>
    for MigrationDammV2CreateMetadataAccounts<'me, 'info>
{
    fn from(
        arr: &'me [AccountInfo<'info>; MIGRATION_DAMM_V2_CREATE_METADATA_IX_ACCOUNTS_LEN],
    ) -> Self {
        Self {
            virtual_pool: &arr[0],
            config: &arr[1],
...
pub fn migration_damm_v2_create_metadata_ix_with_program_id(
    ...
    Ok(Instruction {
        ...
        data: MigrationDammV2CreateMetadataIxData.try_to_vec()?,
    })
}
pub fn migration_damm_v2_create_metadata_ix(
    keys: MigrationDammV2CreateMetadataKeys,
) -> std::io::Result<Instruction> {
    migration_damm_v2_create_metadata_ix_with_program_id(crate::ID, keys)
}
pub fn migration_damm_v2_create_metadata_invoke_with_program_id(
    ...
    let ix = migration_damm_v2_create_metadata_ix_with_program_id(program_id, keys)?;
    invoke_instruction(&ix, accounts)
}
pub fn migration_damm_v2_create_metadata_invoke(
    accounts: MigrationDammV2CreateMetadataAccounts<'_, '_>,
) -> ProgramResult {
    migration_damm_v2_create_metadata_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn migration_damm_v2_create_metadata_invoke_signed(
    ...
    migration_damm_v2_create_metadata_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
...
///MIGRATION_METADATA_SEED_0 seed for migration_metadata PDA: "damm_v2"
pub const MIGRATION_METADATA_SEED_0: &[u8] = &[100u8, 97u8, 109u8, 109u8, 95u8, 118u8, 50u8];
