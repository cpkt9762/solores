...
///Accounts struct for the addLiquidity instruction
...
///Public keys struct for the addLiquidity instruction
...
impl From<&[String]> for AddLiquidityKeys {
...
///Arguments for the addLiquidity instruction
...
impl Default for AddLiquidityIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 5u8,
...
impl From<AddLiquidityIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: AddLiquidityIxArgs) -> Self {
