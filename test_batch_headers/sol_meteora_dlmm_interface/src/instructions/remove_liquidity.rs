...
///Accounts struct for the removeLiquidity instruction
...
///Public keys struct for the removeLiquidity instruction
...
impl From<&[String]> for RemoveLiquidityKeys {
...
///Arguments for the removeLiquidity instruction
...
impl Default for RemoveLiquidityIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 10u8,
...
impl From<RemoveLiquidityIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: RemoveLiquidityIxArgs) -> Self {
