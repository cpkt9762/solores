...
///Accounts struct for the swapExactOut instruction
...
///Public keys struct for the swapExactOut instruction
...
impl From<&[String]> for SwapExactOutKeys {
...
///Arguments for the swapExactOut instruction
...
impl Default for SwapExactOutIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 16u8,
...
impl From<SwapExactOutIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: SwapExactOutIxArgs) -> Self {
