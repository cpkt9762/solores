...
///Accounts struct for the addLiquidityByWeight instruction
...
///Public keys struct for the addLiquidityByWeight instruction
...
impl From<&[String]> for AddLiquidityByWeightKeys {
...
///Arguments for the addLiquidityByWeight instruction
...
impl Default for AddLiquidityByWeightIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 6u8,
...
impl AddLiquidityByWeightIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<AddLiquidityByWeightIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: AddLiquidityByWeightIxArgs) -> Self {
