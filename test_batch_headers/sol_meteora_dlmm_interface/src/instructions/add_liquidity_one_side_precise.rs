...
///Accounts struct for the addLiquidityOneSidePrecise instruction
...
///Public keys struct for the addLiquidityOneSidePrecise instruction
...
impl From<&[String]> for AddLiquidityOneSidePreciseKeys {
...
///Arguments for the addLiquidityOneSidePrecise instruction
...
impl Default for AddLiquidityOneSidePreciseIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 38u8,
...
impl AddLiquidityOneSidePreciseIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<AddLiquidityOneSidePreciseIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: AddLiquidityOneSidePreciseIxArgs) -> Self {
