...
///Accounts struct for the swapWithPriceImpact instruction
...
///Public keys struct for the swapWithPriceImpact instruction
...
impl From<&[String]> for SwapWithPriceImpactKeys {
...
///Arguments for the swapWithPriceImpact instruction
...
impl Default for SwapWithPriceImpactIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 17u8,
...
impl SwapWithPriceImpactIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<SwapWithPriceImpactIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: SwapWithPriceImpactIxArgs) -> Self {
