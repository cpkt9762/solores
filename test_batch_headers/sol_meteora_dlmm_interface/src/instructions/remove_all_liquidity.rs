...
///Accounts struct for the removeAllLiquidity instruction
...
///Public keys struct for the removeAllLiquidity instruction
...
impl From<&[String]> for RemoveAllLiquidityKeys {
