...
///Accounts struct for the addLiquidityByStrategy instruction
...
///Public keys struct for the addLiquidityByStrategy instruction
...
impl From<&[String]> for AddLiquidityByStrategyKeys {
...
///Arguments for the addLiquidityByStrategy instruction
...
impl Default for AddLiquidityByStrategyIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 7u8,
...
impl AddLiquidityByStrategyIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<AddLiquidityByStrategyIxArgs> for MeteoraDlmmProgramIx {
    fn from(args: AddLiquidityByStrategyIxArgs) -> Self {
