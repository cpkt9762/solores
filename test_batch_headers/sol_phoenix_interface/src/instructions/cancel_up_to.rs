...
///Accounts struct for the CancelUpTo instruction
...
///Public keys struct for the CancelUpTo instruction
...
impl From<&[String]> for CancelUpToKeys {
...
///Arguments for the CancelUpTo instruction
...
impl Default for CancelUpToIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 8u8,
...
impl From<CancelUpToIxArgs> for PhoenixProgramIx {
    fn from(args: CancelUpToIxArgs) -> Self {
