...
///Accounts struct for the ChangeMarketStatus instruction
...
///Public keys struct for the ChangeMarketStatus instruction
...
impl From<&[String]> for ChangeMarketStatusKeys {
...
///Arguments for the ChangeMarketStatus instruction
...
impl Default for ChangeMarketStatusIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 103u8,
...
impl From<ChangeMarketStatusIxArgs> for PhoenixProgramIx {
    fn from(args: ChangeMarketStatusIxArgs) -> Self {
