...
///Accounts struct for the CancelMultipleOrdersById instruction
...
///Public keys struct for the CancelMultipleOrdersById instruction
...
impl From<&[String]> for CancelMultipleOrdersByIdKeys {
...
///Arguments for the CancelMultipleOrdersById instruction
...
impl Default for CancelMultipleOrdersByIdIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 10u8,
...
impl CancelMultipleOrdersByIdIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<CancelMultipleOrdersByIdIxArgs> for PhoenixProgramIx {
    fn from(args: CancelMultipleOrdersByIdIxArgs) -> Self {
