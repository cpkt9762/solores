...
///Accounts struct for the CancelAllOrdersWithFreeFunds instruction
...
///Public keys struct for the CancelAllOrdersWithFreeFunds instruction
...
impl From<&[String]> for CancelAllOrdersWithFreeFundsKeys {
