...
///Accounts struct for the CancelMultipleOrdersByIdWithFreeFunds instruction
...
///Public keys struct for the CancelMultipleOrdersByIdWithFreeFunds instruction
...
impl From<&[String]> for CancelMultipleOrdersByIdWithFreeFundsKeys {
...
///Arguments for the CancelMultipleOrdersByIdWithFreeFunds instruction
...
impl Default for CancelMultipleOrdersByIdWithFreeFundsIxArgs {
    fn default() -> Self {
        Self {
            discriminator: 11u8,
...
impl CancelMultipleOrdersByIdWithFreeFundsIxArgs {
    pub fn serialize<W: std::io::Write>(&self, mut writer: W) -> std::io::Result<()> {
...
impl From<CancelMultipleOrdersByIdWithFreeFundsIxArgs> for PhoenixProgramIx {
    fn from(args: CancelMultipleOrdersByIdWithFreeFundsIxArgs) -> Self {
