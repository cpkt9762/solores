...
///Accounts struct for the collect_migrate_fee instruction
...
///Public keys struct for the collect_migrate_fee instruction
...
impl From<&[String]> for CollectMigrateFeeKeys {
...
pub fn collect_migrate_fee_ix(keys: CollectMigrateFeeKeys) -> std::io::Result<Instruction> {
...
pub fn collect_migrate_fee_invoke(accounts: CollectMigrateFeeAccounts<'_, '_>) -> ProgramResult {
    collect_migrate_fee_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn collect_migrate_fee_invoke_signed(
    ...
    collect_migrate_fee_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
