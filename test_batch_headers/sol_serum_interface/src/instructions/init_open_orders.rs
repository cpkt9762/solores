...
///Accounts struct for the InitOpenOrders instruction
...
///Public keys struct for the InitOpenOrders instruction
...
impl From<&[String]> for InitOpenOrdersKeys {
    fn from(pubkeys: &[String]) -> Self {
        Self {
            ...
            market_authority: pubkeys[4].parse().unwrap(),
        }
    }
}
        ...
        if maybe_discm != INIT_OPEN_ORDERS_IX_DISCM {
            return Err(std::io::Error::new(
                ...
                format!(
                    ...
                    INIT_OPEN_ORDERS_IX_DISCM, maybe_discm
                ),
            ));
        }
        Ok(Self)
...
pub fn init_open_orders_invoke(accounts: InitOpenOrdersAccounts<'_, '_>) -> ProgramResult {
    init_open_orders_invoke_with_program_id(crate::ID, accounts)
}
...
pub fn init_open_orders_invoke_signed(
    ...
    init_open_orders_invoke_signed_with_program_id(crate::ID, accounts, seeds)
}
