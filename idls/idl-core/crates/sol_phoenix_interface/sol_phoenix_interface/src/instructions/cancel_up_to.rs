...
//!Instruction: CancelUpTo (NonAnchor)
...
pub struct CancelUpToIxData {
    pub discriminator: u8,
    pub params: crate::types::CancelUpToParams,
}
impl Default for CancelUpToIxData {
    fn default() -> Self {
        Self {
            discriminator: CANCEL_UP_TO_IX_DISCM,
...
impl Default for CancelUpToKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for CancelUpToKeys {
...
impl From<CancelUpToKeys> for [solana_instruction::AccountMeta; CANCEL_UP_TO_IX_ACCOUNTS_LEN] {
...
pub fn cancel_up_to_ix_with_program_id(
    program_id: Pubkey,
    keys: CancelUpToKeys,
    args: CancelUpToIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; CANCEL_UP_TO_IX_ACCOUNTS_LEN] = keys.into();
