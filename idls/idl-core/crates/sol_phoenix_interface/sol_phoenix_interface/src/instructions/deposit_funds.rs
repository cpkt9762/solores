...
//!Instruction: DepositFunds (NonAnchor)
...
pub struct DepositFundsIxData {
    pub discriminator: u8,
    #[cfg_attr(feature = "serde", serde(rename = "depositFundsParams"))]
    pub deposit_funds_params: crate::types::DepositParams,
}
impl Default for DepositFundsIxData {
    fn default() -> Self {
        Self {
            discriminator: DEPOSIT_FUNDS_IX_DISCM,
            deposit_funds_params: Default::default(),
        }
    }
}
impl DepositFundsIxData {
    pub fn new(deposit_funds_params: crate::types::DepositParams) -> Self {
        Self {
        ...
        format!(
            ...
            [
                ...
                format!(
                    "\"{}\":{}",
                    "depositFundsParams",
                    serde_json::to_string(&self.deposit_funds_params)
...
impl Default for DepositFundsKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for DepositFundsKeys {
...
impl From<DepositFundsKeys> for [solana_instruction::AccountMeta; DEPOSIT_FUNDS_IX_ACCOUNTS_LEN] {
...
pub fn deposit_funds_ix_with_program_id(
    ...
    args: DepositFundsIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; DEPOSIT_FUNDS_IX_ACCOUNTS_LEN] = keys.into();
