...
//!Instruction: CancelMultipleOrdersById (NonAnchor)
...
pub struct CancelMultipleOrdersByIdIxData {
    pub discriminator: u8,
    pub params: crate::types::CancelMultipleOrdersByIdParams,
}
impl Default for CancelMultipleOrdersByIdIxData {
    fn default() -> Self {
        Self {
            discriminator: CANCEL_MULTIPLE_ORDERS_BY_ID_IX_DISCM,
...
impl Default for CancelMultipleOrdersByIdKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for CancelMultipleOrdersByIdKeys {
...
impl CancelMultipleOrdersByIdKeys {
...
impl From<CancelMultipleOrdersByIdKeys>
    for [solana_instruction::AccountMeta; CANCEL_MULTIPLE_ORDERS_BY_ID_IX_ACCOUNTS_LEN]
{
...
pub fn cancel_multiple_orders_by_id_ix_with_program_id(
    ...
    args: CancelMultipleOrdersByIdIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; CANCEL_MULTIPLE_ORDERS_BY_ID_IX_ACCOUNTS_LEN] =
        keys.into();
