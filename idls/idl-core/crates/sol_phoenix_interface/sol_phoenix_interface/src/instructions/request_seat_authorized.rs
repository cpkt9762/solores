...
//!Instruction: RequestSeatAuthorized (NonAnchor)
...
impl Default for RequestSeatAuthorizedIxData {
    fn default() -> Self {
        Self {
            discriminator: REQUEST_SEAT_AUTHORIZED_IX_DISCM,
        }
    }
}
...
impl Default for RequestSeatAuthorizedKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for RequestSeatAuthorizedKeys {
...
impl RequestSeatAuthorizedKeys {
...
impl From<RequestSeatAuthorizedKeys>
    for [solana_instruction::AccountMeta; REQUEST_SEAT_AUTHORIZED_IX_ACCOUNTS_LEN]
{
...
pub fn request_seat_authorized_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta; REQUEST_SEAT_AUTHORIZED_IX_ACCOUNTS_LEN] =
        keys.into();
    Ok(solana_instruction::Instruction {
        program_id,
        accounts: Vec::from(metas),
        data: RequestSeatAuthorizedIxData::default().try_to_vec()?,
    })
}
