...
//!Instruction: PlaceLimitOrderWithFreeFunds (NonAnchor)
...
pub struct PlaceLimitOrderWithFreeFundsIxData {
    pub discriminator: u8,
    #[cfg_attr(feature = "serde", serde(rename = "orderPacket"))]
    pub order_packet: crate::types::OrderPacket,
}
impl Default for PlaceLimitOrderWithFreeFundsIxData {
    fn default() -> Self {
        Self {
            discriminator: PLACE_LIMIT_ORDER_WITH_FREE_FUNDS_IX_DISCM,
...
impl Default for PlaceLimitOrderWithFreeFundsKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for PlaceLimitOrderWithFreeFundsKeys {
...
impl PlaceLimitOrderWithFreeFundsKeys {
...
impl From<PlaceLimitOrderWithFreeFundsKeys>
    for [solana_instruction::AccountMeta; PLACE_LIMIT_ORDER_WITH_FREE_FUNDS_IX_ACCOUNTS_LEN]
{
...
pub fn place_limit_order_with_free_funds_ix_with_program_id(
    ...
    args: PlaceLimitOrderWithFreeFundsIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta;
        PLACE_LIMIT_ORDER_WITH_FREE_FUNDS_IX_ACCOUNTS_LEN] = keys.into();
