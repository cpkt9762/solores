...
//!Instruction: WithdrawFunds (NonAnchor)
...
pub struct WithdrawFundsIxData {
    pub discriminator: u8,
    #[cfg_attr(feature = "serde", serde(rename = "withdrawFundsParams"))]
    pub withdraw_funds_params: crate::types::WithdrawParams,
}
impl Default for WithdrawFundsIxData {
    fn default() -> Self {
        Self {
            discriminator: WITHDRAW_FUNDS_IX_DISCM,
            withdraw_funds_params: Default::default(),
        }
    }
}
impl WithdrawFundsIxData {
    pub fn new(withdraw_funds_params: crate::types::WithdrawParams) -> Self {
        Self {
        ...
        format!(
            ...
            [
                ...
                format!(
                    "\"{}\":{}",
                    "withdrawFundsParams",
                    serde_json::to_string(&self.withdraw_funds_params)
...
impl Default for WithdrawFundsKeys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for WithdrawFundsKeys {
...
impl From<WithdrawFundsKeys> for [solana_instruction::AccountMeta; WITHDRAW_FUNDS_IX_ACCOUNTS_LEN] {
...
pub fn withdraw_funds_ix_with_program_id(
    ...
    args: WithdrawFundsIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; WITHDRAW_FUNDS_IX_ACCOUNTS_LEN] = keys.into();
