...
//!Instruction: swap_exact_out
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const SWAP_EXACT_OUT_IX_DISCM: [u8; 8] = [250u8, 73u8, 101u8, 33u8, 38u8, 207u8, 75u8, 184u8];
pub const SWAP_EXACT_OUT_IX_ACCOUNTS_LEN: usize = 15;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapExactOutIxData {
    pub discriminator: [u8; 8],
    pub max_in_amount: u64,
    pub out_amount: u64,
}
impl Default for SwapExactOutIxData {
    fn default() -> Self {
        Self {
            discriminator: SWAP_EXACT_OUT_IX_DISCM,
...
impl SwapExactOutIxData {
    pub fn new(max_in_amount: u64, out_amount: u64) -> Self {
        Self {
...
impl From<&[Pubkey]> for SwapExactOutKeys {
...
impl From<SwapExactOutKeys> for [solana_instruction::AccountMeta; SWAP_EXACT_OUT_IX_ACCOUNTS_LEN] {
...
pub fn swap_exact_out_ix_with_program_id(
    ...
    args: SwapExactOutIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; SWAP_EXACT_OUT_IX_ACCOUNTS_LEN] = keys.into();
