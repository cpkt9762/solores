...
//!Instruction: remove_all_liquidity
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const REMOVE_ALL_LIQUIDITY_IX_DISCM: [u8; 8] =
...
impl Default for RemoveAllLiquidityIxData {
    fn default() -> Self {
        Self {
            discriminator: REMOVE_ALL_LIQUIDITY_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for RemoveAllLiquidityKeys {
...
impl From<RemoveAllLiquidityKeys>
    for [solana_instruction::AccountMeta; REMOVE_ALL_LIQUIDITY_IX_ACCOUNTS_LEN]
{
...
pub fn remove_all_liquidity_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta; REMOVE_ALL_LIQUIDITY_IX_ACCOUNTS_LEN] =
        keys.into();
    let args = RemoveAllLiquidityIxData::default();
