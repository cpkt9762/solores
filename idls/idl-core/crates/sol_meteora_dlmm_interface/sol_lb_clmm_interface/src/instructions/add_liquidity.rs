...
pub const ADD_LIQUIDITY_IX_DISCM: [u8; 8] = [181u8, 157u8, 89u8, 67u8, 143u8, 182u8, 52u8, 72u8];
...
impl Default for AddLiquidityIxData {
    fn default() -> Self {
        Self {
            discriminator: ADD_LIQUIDITY_IX_DISCM,
            liquidity_parameter: Default::default(),
        }
    }
}
impl AddLiquidityIxData {
    pub fn new(liquidity_parameter: crate::types::LiquidityParameter) -> Self {
        Self {
...
impl From<&[Pubkey]> for AddLiquidityKeys {
...
impl From<AddLiquidityKeys> for [solana_instruction::AccountMeta; ADD_LIQUIDITY_IX_ACCOUNTS_LEN] {
...
pub fn add_liquidity_ix_with_program_id(
    ...
    args: AddLiquidityIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; ADD_LIQUIDITY_IX_ACCOUNTS_LEN] = keys.into();
