...
//!Instruction: close_claim_protocol_fee_operator
...
impl Default for CloseClaimProtocolFeeOperatorIxData {
    fn default() -> Self {
        Self {
            discriminator: CLOSE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for CloseClaimProtocolFeeOperatorKeys {
...
impl CloseClaimProtocolFeeOperatorKeys {
    /// Convert Keys to Vec<Pubkey>
    pub fn to_vec(&self) -> Vec<Pubkey> {
        vec![self.claim_fee_operator, self.rent_receiver, self.admin]
    }
    /// Manual JSON serialization
    #[cfg(feature = "serde")]
    pub fn to_json(&self) -> String {
...
impl From<CloseClaimProtocolFeeOperatorKeys>
    for [solana_instruction::AccountMeta; CLOSE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_ACCOUNTS_LEN]
{
...
pub fn close_claim_protocol_fee_operator_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta;
        CLOSE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_ACCOUNTS_LEN] = keys.into();
    let args = CloseClaimProtocolFeeOperatorIxData::default();
