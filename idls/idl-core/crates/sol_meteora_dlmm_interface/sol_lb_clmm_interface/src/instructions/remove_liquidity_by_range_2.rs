...
pub const REMOVE_LIQUIDITY_BY_RANGE_2_IX_DISCM: [u8; 8] =
    [204u8, 2u8, 195u8, 145u8, 53u8, 145u8, 145u8, 205u8];
pub const REMOVE_LIQUIDITY_BY_RANGE_2_IX_ACCOUNTS_LEN: usize = 15;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RemoveLiquidityByRange2IxData {
...
impl Default for RemoveLiquidityByRange2IxData {
    fn default() -> Self {
        Self {
            discriminator: REMOVE_LIQUIDITY_BY_RANGE_2_IX_DISCM,
...
impl From<&[Pubkey]> for RemoveLiquidityByRange2Keys {
...
impl RemoveLiquidityByRange2Keys {
...
impl From<RemoveLiquidityByRange2Keys>
    for [solana_instruction::AccountMeta; REMOVE_LIQUIDITY_BY_RANGE_2_IX_ACCOUNTS_LEN]
{
...
pub fn remove_liquidity_by_range_2_ix_with_program_id(
    program_id: Pubkey,
    keys: RemoveLiquidityByRange2Keys,
    args: RemoveLiquidityByRange2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; REMOVE_LIQUIDITY_BY_RANGE_2_IX_ACCOUNTS_LEN] =
        keys.into();
...
pub fn remove_liquidity_by_range_2_ix(
    keys: RemoveLiquidityByRange2Keys,
    args: RemoveLiquidityByRange2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    remove_liquidity_by_range_2_ix_with_program_id(crate::ID, keys, args)
}
