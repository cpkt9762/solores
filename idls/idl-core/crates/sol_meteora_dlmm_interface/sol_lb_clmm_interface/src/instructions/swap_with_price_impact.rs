...
//!Instruction: swap_with_price_impact
...
pub struct SwapWithPriceImpactIxData {
    pub discriminator: [u8; 8],
    pub amount_in: u64,
    pub active_id: Option<i32>,
    pub max_price_impact_bps: u16,
}
impl Default for SwapWithPriceImpactIxData {
    fn default() -> Self {
        Self {
            discriminator: SWAP_WITH_PRICE_IMPACT_IX_DISCM,
...
impl SwapWithPriceImpactIxData {
    pub fn new(amount_in: u64, active_id: Option<i32>, max_price_impact_bps: u16) -> Self {
        Self {
...
impl From<&[Pubkey]> for SwapWithPriceImpactKeys {
...
impl From<SwapWithPriceImpactKeys>
    for [solana_instruction::AccountMeta; SWAP_WITH_PRICE_IMPACT_IX_ACCOUNTS_LEN]
{
...
pub fn swap_with_price_impact_ix_with_program_id(
    ...
    args: SwapWithPriceImpactIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; SWAP_WITH_PRICE_IMPACT_IX_ACCOUNTS_LEN] =
        keys.into();
