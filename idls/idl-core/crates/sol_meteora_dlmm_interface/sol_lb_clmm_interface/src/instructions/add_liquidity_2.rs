...
//!Instruction: add_liquidity2
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const ADD_LIQUIDITY_2_IX_DISCM: [u8; 8] = [228u8, 162u8, 78u8, 28u8, 70u8, 219u8, 116u8, 115u8];
pub const ADD_LIQUIDITY_2_IX_ACCOUNTS_LEN: usize = 14;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct AddLiquidity2IxData {
    pub discriminator: [u8; 8],
    pub liquidity_parameter: crate::types::LiquidityParameter,
    pub remaining_accounts_info: crate::types::RemainingAccountsInfo,
}
impl Default for AddLiquidity2IxData {
    fn default() -> Self {
        Self {
            discriminator: ADD_LIQUIDITY_2_IX_DISCM,
...
impl AddLiquidity2IxData {
    pub fn new(
        liquidity_parameter: crate::types::LiquidityParameter,
...
impl From<&[Pubkey]> for AddLiquidity2Keys {
...
impl From<AddLiquidity2Keys>
    for [solana_instruction::AccountMeta; ADD_LIQUIDITY_2_IX_ACCOUNTS_LEN]
{
...
pub fn add_liquidity_2_ix_with_program_id(
    program_id: Pubkey,
    keys: AddLiquidity2Keys,
    args: AddLiquidity2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; ADD_LIQUIDITY_2_IX_ACCOUNTS_LEN] = keys.into();
...
pub fn add_liquidity_2_ix(
    keys: AddLiquidity2Keys,
    args: AddLiquidity2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    add_liquidity_2_ix_with_program_id(crate::ID, keys, args)
}
