...
//!Instruction: initialize_customizable_permissionless_lb_pair
...
impl Default for InitializeCustomizablePermissionlessLbPairIxData {
    fn default() -> Self {
        Self {
            discriminator: INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_DISCM,
...
impl From<&[Pubkey]> for InitializeCustomizablePermissionlessLbPairKeys {
...
impl InitializeCustomizablePermissionlessLbPairKeys {
...
pub fn initialize_customizable_permissionless_lb_pair_ix_with_program_id(
    ...
    args: InitializeCustomizablePermissionlessLbPairIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta;
        INITIALIZE_CUSTOMIZABLE_PERMISSIONLESS_LB_PAIR_IX_ACCOUNTS_LEN] = keys.into();
