...
//!Instruction: create_claim_protocol_fee_operator
...
impl Default for CreateClaimProtocolFeeOperatorIxData {
    fn default() -> Self {
        Self {
            discriminator: CREATE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for CreateClaimProtocolFeeOperatorKeys {
...
impl CreateClaimProtocolFeeOperatorKeys {
...
impl From<CreateClaimProtocolFeeOperatorKeys>
    for [solana_instruction::AccountMeta; CREATE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_ACCOUNTS_LEN]
{
...
pub fn create_claim_protocol_fee_operator_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta;
        CREATE_CLAIM_PROTOCOL_FEE_OPERATOR_IX_ACCOUNTS_LEN] = keys.into();
    let args = CreateClaimProtocolFeeOperatorIxData::default();
