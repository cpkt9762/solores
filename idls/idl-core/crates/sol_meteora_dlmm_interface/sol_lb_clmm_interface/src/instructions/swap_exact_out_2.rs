...
//!Instruction: swap_exact_out2
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const SWAP_EXACT_OUT_2_IX_DISCM: [u8; 8] =
    [43u8, 215u8, 247u8, 132u8, 137u8, 60u8, 243u8, 81u8];
pub const SWAP_EXACT_OUT_2_IX_ACCOUNTS_LEN: usize = 16;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapExactOut2IxData {
    pub discriminator: [u8; 8],
    pub max_in_amount: u64,
    pub out_amount: u64,
    pub remaining_accounts_info: crate::types::RemainingAccountsInfo,
}
impl Default for SwapExactOut2IxData {
    fn default() -> Self {
        Self {
            discriminator: SWAP_EXACT_OUT_2_IX_DISCM,
            max_in_amount: Default::default(),
    ...
    pub fn to_json(&self) -> String {
        format!(
            ...
            [
                ...
                format!("\"{}\":{}", "max_in_amount", self.max_in_amount),
                format!("\"{}\":{}", "out_amount", self.out_amount),
                format!(
                    "\"{}\":{}",
                    "remaining_accounts_info",
...
impl From<&[Pubkey]> for SwapExactOut2Keys {
...
impl From<SwapExactOut2Keys>
    for [solana_instruction::AccountMeta; SWAP_EXACT_OUT_2_IX_ACCOUNTS_LEN]
{
...
pub fn swap_exact_out_2_ix_with_program_id(
    program_id: Pubkey,
    keys: SwapExactOut2Keys,
    args: SwapExactOut2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; SWAP_EXACT_OUT_2_IX_ACCOUNTS_LEN] = keys.into();
...
pub fn swap_exact_out_2_ix(
    keys: SwapExactOut2Keys,
    args: SwapExactOut2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    swap_exact_out_2_ix_with_program_id(crate::ID, keys, args)
}
