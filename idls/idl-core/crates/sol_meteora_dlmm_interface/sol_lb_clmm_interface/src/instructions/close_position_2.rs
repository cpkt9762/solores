...
//!Instruction: close_position2
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const CLOSE_POSITION_2_IX_DISCM: [u8; 8] =
    [174u8, 90u8, 35u8, 115u8, 186u8, 40u8, 147u8, 226u8];
pub const CLOSE_POSITION_2_IX_ACCOUNTS_LEN: usize = 5;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClosePosition2IxData {
    pub discriminator: [u8; 8],
}
impl Default for ClosePosition2IxData {
    fn default() -> Self {
        Self {
            discriminator: CLOSE_POSITION_2_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for ClosePosition2Keys {
...
impl From<ClosePosition2Keys>
    for [solana_instruction::AccountMeta; CLOSE_POSITION_2_IX_ACCOUNTS_LEN]
{
...
pub fn close_position_2_ix_with_program_id(
    program_id: Pubkey,
    keys: ClosePosition2Keys,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; CLOSE_POSITION_2_IX_ACCOUNTS_LEN] = keys.into();
    let args = ClosePosition2IxData::default();
...
pub fn close_position_2_ix(
    keys: ClosePosition2Keys,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    close_position_2_ix_with_program_id(crate::ID, keys)
}
