...
pub struct AddLiquidityByStrategyIxData {
    pub discriminator: [u8; 8],
    pub liquidity_parameter: crate::types::LiquidityParameterByStrategy,
}
impl Default for AddLiquidityByStrategyIxData {
    fn default() -> Self {
        Self {
            discriminator: ADD_LIQUIDITY_BY_STRATEGY_IX_DISCM,
            liquidity_parameter: Default::default(),
        }
    }
}
impl AddLiquidityByStrategyIxData {
    pub fn new(liquidity_parameter: crate::types::LiquidityParameterByStrategy) -> Self {
        Self {
...
impl From<&[Pubkey]> for AddLiquidityByStrategyKeys {
...
impl AddLiquidityByStrategyKeys {
...
impl From<AddLiquidityByStrategyKeys>
    for [solana_instruction::AccountMeta; ADD_LIQUIDITY_BY_STRATEGY_IX_ACCOUNTS_LEN]
{
...
pub fn add_liquidity_by_strategy_ix_with_program_id(
    ...
    args: AddLiquidityByStrategyIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; ADD_LIQUIDITY_BY_STRATEGY_IX_ACCOUNTS_LEN] =
        keys.into();
