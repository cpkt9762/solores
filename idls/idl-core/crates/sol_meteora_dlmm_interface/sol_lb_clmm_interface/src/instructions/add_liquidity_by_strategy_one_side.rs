...
//!Instruction: add_liquidity_by_strategy_one_side
...
pub struct AddLiquidityByStrategyOneSideIxData {
    pub discriminator: [u8; 8],
    pub liquidity_parameter: crate::types::LiquidityParameterByStrategyOneSide,
}
impl Default for AddLiquidityByStrategyOneSideIxData {
    fn default() -> Self {
        Self {
            discriminator: ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_DISCM,
            liquidity_parameter: Default::default(),
        }
    }
}
impl AddLiquidityByStrategyOneSideIxData {
    pub fn new(liquidity_parameter: crate::types::LiquidityParameterByStrategyOneSide) -> Self {
        Self {
...
impl From<&[Pubkey]> for AddLiquidityByStrategyOneSideKeys {
...
impl AddLiquidityByStrategyOneSideKeys {
...
impl From<AddLiquidityByStrategyOneSideKeys>
    for [solana_instruction::AccountMeta; ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_ACCOUNTS_LEN]
{
...
pub fn add_liquidity_by_strategy_one_side_ix_with_program_id(
    ...
    args: AddLiquidityByStrategyOneSideIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta;
        ADD_LIQUIDITY_BY_STRATEGY_ONE_SIDE_IX_ACCOUNTS_LEN] = keys.into();
