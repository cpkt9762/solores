...
//!Instruction: initialize_preset_parameter
...
pub struct InitializePresetParameterIxData {
    pub discriminator: [u8; 8],
    pub ix: crate::types::InitPresetParametersIx,
}
impl Default for InitializePresetParameterIxData {
    fn default() -> Self {
        Self {
            discriminator: INITIALIZE_PRESET_PARAMETER_IX_DISCM,
            ix: Default::default(),
        }
    }
}
impl InitializePresetParameterIxData {
    pub fn new(ix: crate::types::InitPresetParametersIx) -> Self {
        Self {
...
impl From<&[Pubkey]> for InitializePresetParameterKeys {
...
impl InitializePresetParameterKeys {
...
impl From<InitializePresetParameterKeys>
    for [solana_instruction::AccountMeta; INITIALIZE_PRESET_PARAMETER_IX_ACCOUNTS_LEN]
{
...
pub fn initialize_preset_parameter_ix_with_program_id(
    ...
    args: InitializePresetParameterIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; INITIALIZE_PRESET_PARAMETER_IX_ACCOUNTS_LEN] =
        keys.into();
