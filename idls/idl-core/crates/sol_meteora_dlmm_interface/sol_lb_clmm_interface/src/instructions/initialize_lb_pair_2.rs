...
//!Instruction: initialize_lb_pair2
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const INITIALIZE_LB_PAIR_2_IX_DISCM: [u8; 8] =
    [73u8, 59u8, 36u8, 120u8, 237u8, 83u8, 108u8, 198u8];
pub const INITIALIZE_LB_PAIR_2_IX_ACCOUNTS_LEN: usize = 16;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct InitializeLbPair2IxData {
    pub discriminator: [u8; 8],
    pub params: crate::types::InitializeLbPair2Params,
}
impl Default for InitializeLbPair2IxData {
    fn default() -> Self {
        Self {
            discriminator: INITIALIZE_LB_PAIR_2_IX_DISCM,
            params: Default::default(),
        }
    }
}
impl InitializeLbPair2IxData {
    pub fn new(params: crate::types::InitializeLbPair2Params) -> Self {
        Self {
...
impl From<&[Pubkey]> for InitializeLbPair2Keys {
...
impl From<InitializeLbPair2Keys>
    for [solana_instruction::AccountMeta; INITIALIZE_LB_PAIR_2_IX_ACCOUNTS_LEN]
{
...
pub fn initialize_lb_pair_2_ix_with_program_id(
    program_id: Pubkey,
    keys: InitializeLbPair2Keys,
    args: InitializeLbPair2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; INITIALIZE_LB_PAIR_2_IX_ACCOUNTS_LEN] =
        keys.into();
...
pub fn initialize_lb_pair_2_ix(
    keys: InitializeLbPair2Keys,
    args: InitializeLbPair2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    initialize_lb_pair_2_ix_with_program_id(crate::ID, keys, args)
}
