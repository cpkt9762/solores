...
//!Instruction: swap_with_price_impact2
#[allow(unused_imports)]
use solana_pubkey::Pubkey;
pub const SWAP_WITH_PRICE_IMPACT_2_IX_DISCM: [u8; 8] =
    [74u8, 98u8, 192u8, 214u8, 177u8, 51u8, 75u8, 51u8];
pub const SWAP_WITH_PRICE_IMPACT_2_IX_ACCOUNTS_LEN: usize = 16;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct SwapWithPriceImpact2IxData {
...
impl Default for SwapWithPriceImpact2IxData {
    fn default() -> Self {
        Self {
            discriminator: SWAP_WITH_PRICE_IMPACT_2_IX_DISCM,
            amount_in: Default::default(),
            active_id: Default::default(),
            max_price_impact_bps: Default::default(),
        ...
        format!(
            ...
            [
                ...
                format!(
                    "\"{}\":{}",
                    "active_id",
                    serde_json::to_string(&self.active_id).unwrap_or_else(|_| "null".to_string())
                ),
                format!(
                    "\"{}\":{}",
...
impl From<&[Pubkey]> for SwapWithPriceImpact2Keys {
...
impl From<SwapWithPriceImpact2Keys>
    for [solana_instruction::AccountMeta; SWAP_WITH_PRICE_IMPACT_2_IX_ACCOUNTS_LEN]
{
...
pub fn swap_with_price_impact_2_ix_with_program_id(
    program_id: Pubkey,
    keys: SwapWithPriceImpact2Keys,
    args: SwapWithPriceImpact2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; SWAP_WITH_PRICE_IMPACT_2_IX_ACCOUNTS_LEN] =
        keys.into();
...
pub fn swap_with_price_impact_2_ix(
    keys: SwapWithPriceImpact2Keys,
    args: SwapWithPriceImpact2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    swap_with_price_impact_2_ix_with_program_id(crate::ID, keys, args)
}
