...
pub const REMOVE_LIQUIDITY_IX_DISCM: [u8; 8] = [80u8, 85u8, 209u8, 72u8, 24u8, 206u8, 177u8, 108u8];
pub const REMOVE_LIQUIDITY_IX_ACCOUNTS_LEN: usize = 16;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RemoveLiquidityIxData {
    pub discriminator: [u8; 8],
    pub bin_liquidity_removal: Vec<crate::types::BinLiquidityReduction>,
}
impl Default for RemoveLiquidityIxData {
    fn default() -> Self {
        Self {
            discriminator: REMOVE_LIQUIDITY_IX_DISCM,
            bin_liquidity_removal: Default::default(),
        }
    }
}
impl RemoveLiquidityIxData {
    pub fn new(bin_liquidity_removal: Vec<crate::types::BinLiquidityReduction>) -> Self {
        Self {
...
impl From<&[Pubkey]> for RemoveLiquidityKeys {
...
impl From<RemoveLiquidityKeys>
    for [solana_instruction::AccountMeta; REMOVE_LIQUIDITY_IX_ACCOUNTS_LEN]
{
...
pub fn remove_liquidity_ix_with_program_id(
    ...
    args: RemoveLiquidityIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; REMOVE_LIQUIDITY_IX_ACCOUNTS_LEN] = keys.into();
