...
//!Instruction: close_preset_parameter
...
impl Default for ClosePresetParameterIxData {
    fn default() -> Self {
        Self {
            discriminator: CLOSE_PRESET_PARAMETER_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for ClosePresetParameterKeys {
...
impl From<ClosePresetParameterKeys>
    for [solana_instruction::AccountMeta; CLOSE_PRESET_PARAMETER_IX_ACCOUNTS_LEN]
{
...
pub fn close_preset_parameter_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta; CLOSE_PRESET_PARAMETER_IX_ACCOUNTS_LEN] =
        keys.into();
    let args = ClosePresetParameterIxData::default();
