...
pub const DUMMY_ZC_ACCOUNT_ACCOUNT_DISCM: [u8; 8] =
    [94u8, 107u8, 238u8, 80u8, 208u8, 48u8, 180u8, 8u8];
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DummyZcAccount {
    pub discriminator: [u8; 8],
    pub position_bin_data: crate::types::PositionBinData,
}
impl Default for DummyZcAccount {
    fn default() -> Self {
        Self {
            discriminator: DUMMY_ZC_ACCOUNT_ACCOUNT_DISCM,
            position_bin_data: Default::default(),
        }
    }
}
impl DummyZcAccount {
    pub const MEM_LEN: usize = std::mem::size_of::<Self>();
    pub const PACKED_LEN: usize = 16usize;
    pub fn discriminator() -> [u8; 8] {
        DUMMY_ZC_ACCOUNT_ACCOUNT_DISCM
    }
