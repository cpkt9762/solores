...
pub struct UpdateFeeConfigIxData {
...
impl Default for UpdateFeeConfigIxData {
    fn default() -> Self {
        Self {
            discriminator: UPDATE_FEE_CONFIG_IX_DISCM,
...
impl From<&[Pubkey]> for UpdateFeeConfigKeys {
...
impl From<UpdateFeeConfigKeys>
    for [solana_instruction::AccountMeta; UPDATE_FEE_CONFIG_IX_ACCOUNTS_LEN]
{
...
pub fn update_fee_config_ix_with_program_id(
    ...
    args: UpdateFeeConfigIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; UPDATE_FEE_CONFIG_IX_ACCOUNTS_LEN] = keys.into();
