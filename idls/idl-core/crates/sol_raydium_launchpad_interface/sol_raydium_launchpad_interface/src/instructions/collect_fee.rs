...
impl Default for CollectFeeIxData {
    fn default() -> Self {
        Self {
            discriminator: COLLECT_FEE_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for CollectFeeKeys {
...
impl From<CollectFeeKeys> for [solana_instruction::AccountMeta; COLLECT_FEE_IX_ACCOUNTS_LEN] {
...
pub fn collect_fee_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta; COLLECT_FEE_IX_ACCOUNTS_LEN] = keys.into();
    let args = CollectFeeIxData::default();
