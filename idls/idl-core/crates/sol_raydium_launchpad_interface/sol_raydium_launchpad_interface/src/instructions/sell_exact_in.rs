...
pub struct SellExactInIxData {
    pub discriminator: [u8; 8],
    pub amount_in: u64,
    pub minimum_amount_out: u64,
    pub share_fee_rate: u64,
}
impl Default for SellExactInIxData {
    fn default() -> Self {
        Self {
            discriminator: SELL_EXACT_IN_IX_DISCM,
...
impl SellExactInIxData {
    pub fn new(amount_in: u64, minimum_amount_out: u64, share_fee_rate: u64) -> Self {
        Self {
...
impl From<&[Pubkey]> for SellExactInKeys {
...
impl From<SellExactInKeys> for [solana_instruction::AccountMeta; SELL_EXACT_IN_IX_ACCOUNTS_LEN] {
...
pub fn sell_exact_in_ix_with_program_id(
    ...
    args: SellExactInIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; SELL_EXACT_IN_IX_ACCOUNTS_LEN] = keys.into();
