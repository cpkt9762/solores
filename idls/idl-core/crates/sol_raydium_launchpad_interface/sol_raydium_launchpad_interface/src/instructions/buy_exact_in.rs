...
pub struct BuyExactInIxData {
    pub discriminator: [u8; 8],
    pub amount_in: u64,
    pub minimum_amount_out: u64,
    pub share_fee_rate: u64,
}
impl Default for BuyExactInIxData {
    fn default() -> Self {
        Self {
            discriminator: BUY_EXACT_IN_IX_DISCM,
...
impl From<&[Pubkey]> for BuyExactInKeys {
...
impl From<BuyExactInKeys> for [solana_instruction::AccountMeta; BUY_EXACT_IN_IX_ACCOUNTS_LEN] {
...
pub fn buy_exact_in_ix_with_program_id(
    program_id: Pubkey,
    keys: BuyExactInKeys,
    args: BuyExactInIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; BUY_EXACT_IN_IX_ACCOUNTS_LEN] = keys.into();
