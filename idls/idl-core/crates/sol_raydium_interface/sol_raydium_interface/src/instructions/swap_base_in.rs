...
//!Instruction: swapBaseIn (NonAnchor)
...
impl Default for SwapBaseInIxData {
    fn default() -> Self {
        Self {
            discriminator: SWAP_BASE_IN_IX_DISCM,
    ...
    pub fn to_json(&self) -> String {
        format!(
            ...
            [
                ...
                format!("\"{}\":{}", "amountIn", self.amount_in),
                format!("\"{}\":{}", "minimumAmountOut", self.minimum_amount_out)
            ]
            .join(",")
        )
    }
...
impl Default for SwapBaseInKeys {
    fn default() -> Self {
        Self {
...
impl From<SwapBaseInKeys> for Vec<solana_instruction::AccountMeta> {
