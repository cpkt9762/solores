...
pub const DECREASE_LIQUIDITY_V_2_IX_DISCM: [u8; 8] =
    [82u8, 1u8, 46u8, 234u8, 207u8, 210u8, 241u8, 169u8];
pub const DECREASE_LIQUIDITY_V_2_IX_ACCOUNTS_LEN: usize = 15;
#[derive(borsh::BorshDeserialize, borsh::BorshSerialize, Clone, Debug, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct DecreaseLiquidityV2IxData {
...
impl Default for DecreaseLiquidityV2IxData {
    fn default() -> Self {
        Self {
            discriminator: DECREASE_LIQUIDITY_V_2_IX_DISCM,
...
impl From<&[Pubkey]> for DecreaseLiquidityV2Keys {
...
impl From<DecreaseLiquidityV2Keys>
    for [solana_instruction::AccountMeta; DECREASE_LIQUIDITY_V_2_IX_ACCOUNTS_LEN]
{
...
pub fn decrease_liquidity_v_2_ix_with_program_id(
    program_id: Pubkey,
    keys: DecreaseLiquidityV2Keys,
    args: DecreaseLiquidityV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; DECREASE_LIQUIDITY_V_2_IX_ACCOUNTS_LEN] =
        keys.into();
...
pub fn decrease_liquidity_v_2_ix(
    keys: DecreaseLiquidityV2Keys,
    args: DecreaseLiquidityV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    decrease_liquidity_v_2_ix_with_program_id(crate::ID, keys, args)
}
