...
//!Instruction: CancelOrderByClientIdV2 (NonAnchor)
...
pub struct CancelOrderByClientIdV2IxData {
    pub discriminator: u8,
    pub client_order_id: u64,
}
impl Default for CancelOrderByClientIdV2IxData {
    fn default() -> Self {
        Self {
            discriminator: CANCEL_ORDER_BY_CLIENT_ID_V2_IX_DISCM,
...
impl Default for CancelOrderByClientIdV2Keys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for CancelOrderByClientIdV2Keys {
...
impl CancelOrderByClientIdV2Keys {
...
impl From<CancelOrderByClientIdV2Keys>
    for [solana_instruction::AccountMeta; CANCEL_ORDER_BY_CLIENT_ID_V2_IX_ACCOUNTS_LEN]
{
...
pub fn cancel_order_by_client_id_v_2_ix_with_program_id(
    program_id: Pubkey,
    keys: CancelOrderByClientIdV2Keys,
    args: CancelOrderByClientIdV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; CANCEL_ORDER_BY_CLIENT_ID_V2_IX_ACCOUNTS_LEN] =
        keys.into();
...
pub fn cancel_order_by_client_id_v_2_ix(
    keys: CancelOrderByClientIdV2Keys,
    args: CancelOrderByClientIdV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    cancel_order_by_client_id_v_2_ix_with_program_id(crate::ID, keys, args)
}
