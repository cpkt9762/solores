...
//!Instruction: NewOrderV2 (NonAnchor)
...
pub struct NewOrderV2IxData {
    pub discriminator: u8,
    pub args: crate::types::NewOrderInstructionV2,
}
impl Default for NewOrderV2IxData {
    fn default() -> Self {
        Self {
            discriminator: NEW_ORDER_V2_IX_DISCM,
            args: Default::default(),
        }
    }
}
impl NewOrderV2IxData {
    pub fn new(args: crate::types::NewOrderInstructionV2) -> Self {
        Self {
...
impl Default for NewOrderV2Keys {
    fn default() -> Self {
        Self {
...
impl From<&[Pubkey]> for NewOrderV2Keys {
...
impl From<NewOrderV2Keys> for [solana_instruction::AccountMeta; NEW_ORDER_V2_IX_ACCOUNTS_LEN] {
...
pub fn new_order_v_2_ix_with_program_id(
    program_id: Pubkey,
    keys: NewOrderV2Keys,
    args: NewOrderV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; NEW_ORDER_V2_IX_ACCOUNTS_LEN] = keys.into();
...
pub fn new_order_v_2_ix(
    keys: NewOrderV2Keys,
    args: NewOrderV2IxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    new_order_v_2_ix_with_program_id(crate::ID, keys, args)
}
