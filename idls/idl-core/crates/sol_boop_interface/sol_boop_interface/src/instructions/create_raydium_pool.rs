...
//!Instruction: create_raydium_pool
...
impl Default for CreateRaydiumPoolIxData {
    fn default() -> Self {
        Self {
            discriminator: CREATE_RAYDIUM_POOL_IX_DISCM,
        }
    }
}
...
impl From<&[Pubkey]> for CreateRaydiumPoolKeys {
...
impl From<CreateRaydiumPoolKeys>
    for [solana_instruction::AccountMeta; CREATE_RAYDIUM_POOL_IX_ACCOUNTS_LEN]
{
...
pub fn create_raydium_pool_ix_with_program_id(
    ...
    let metas: [solana_instruction::AccountMeta; CREATE_RAYDIUM_POOL_IX_ACCOUNTS_LEN] = keys.into();
    let args = CreateRaydiumPoolIxData::default();
