...
impl Default for CreateTokenIxData {
    fn default() -> Self {
        Self {
            discriminator: CREATE_TOKEN_IX_DISCM,
...
impl From<&[Pubkey]> for CreateTokenKeys {
...
impl From<CreateTokenKeys> for [solana_instruction::AccountMeta; CREATE_TOKEN_IX_ACCOUNTS_LEN] {
...
pub fn create_token_ix_with_program_id(
    ...
    args: CreateTokenIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; CREATE_TOKEN_IX_ACCOUNTS_LEN] = keys.into();
