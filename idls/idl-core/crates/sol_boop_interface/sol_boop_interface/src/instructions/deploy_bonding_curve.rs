...
//!Instruction: deploy_bonding_curve
...
pub struct DeployBondingCurveIxData {
...
impl Default for DeployBondingCurveIxData {
    fn default() -> Self {
        Self {
            discriminator: DEPLOY_BONDING_CURVE_IX_DISCM,
...
impl From<&[Pubkey]> for DeployBondingCurveKeys {
...
impl From<DeployBondingCurveKeys>
    for [solana_instruction::AccountMeta; DEPLOY_BONDING_CURVE_IX_ACCOUNTS_LEN]
{
...
pub fn deploy_bonding_curve_ix_with_program_id(
    ...
    args: DeployBondingCurveIxData,
) -> Result<solana_instruction::Instruction, std::io::Error> {
    let metas: [solana_instruction::AccountMeta; DEPLOY_BONDING_CURVE_IX_ACCOUNTS_LEN] =
        keys.into();
